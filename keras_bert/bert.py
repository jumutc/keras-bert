...
def get_model(token_num,
    ...
    mlm_pred_layer = keras.layers.Softmax(name='MLM-Pred')(mlm_sim_layer)
    ...
    model.compile(
        optimizer=keras.optimizers.Adam(lr=lr, epsilon=1e-6, decay=0.01),
...
def gen_batch_inputs(sentence_pairs,
    ...
    for i in range(batch_size):
        ...
        if i == mapped_i:
            ...
            first, second = sentences[i][offset], sentences[i][offset+1]
        else:
